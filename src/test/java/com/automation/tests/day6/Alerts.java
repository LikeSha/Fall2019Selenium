...
,you need to click "ok" , use this command : alert.accept();  then pay attention here : when you do
comparason of expected and actual result , teacher used " endsWith() method.
